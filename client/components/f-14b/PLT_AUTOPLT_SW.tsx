  ...
  return (
    <>
      <div className="absolute left-[28px] top-[121px]">
        {modes[0] > 0 && <F14Image url="PLT_AUTOPLT_VECTOR-1" w={24} h={58} />}
      </div>
      <div className="absolute left-[28px] top-[121px]">
        {modes[0] > 1 && <F14Image url="PLT_AUTOPLT_VECTOR-2" w={24} h={58} />}
      </div>
      ...
      <div className="absolute left-[151px] top-[121px]">
        {modes[2] > 0 && <F14Image url="PLT_AUTOPLT_HDG-1" w={18} h={58} />}
      </div>
      <div className="absolute left-[151px] top-[121px]">
        {modes[2] > 1 && <F14Image url="PLT_AUTOPLT_HDG-2" w={18} h={58} />}
      </div>
